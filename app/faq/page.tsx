export const metadata = { title: 'FAQ — DockTease Miami' };
...
const FAQ = [
  ...
  { q: 'What happens in bad weather?', a: 'Safety first. If there\'s a small craft advisory, lightning, or sustained winds over 30 mph, we\'ll reschedule your charter at no charge. A little rain won\'t stop us though — Miami weather changes fast.' },
  ...
  { q: 'What\'s the maximum capacity?', a: 'Varies by yacht — 8 guests on Pink Leopard (45ft), 10 on our 50ft Maxums, and 12 on our 60ft Azimuts. This includes everyone on board except crew.' },
      ...
      {FAQ.map((item, i) => (
        <details key={i} style={{ borderBottom: '1px solid #222', padding: '20px 0', cursor: 'pointer' }}>
          <summary style={{ fontSize: '1.15rem', fontWeight: 600, listStyle: 'none', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            {item.q}
            <span style={{ fontSize: '1.3rem', color: '#f472b6', marginLeft: 16 }}>+</span>
          </summary>
